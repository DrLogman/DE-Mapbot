...
\\ SO I think that if you put the 4 void runs below, into the above void loop with the current two variables, 
add two more, and set up each variable to be either stop, go, right, left, it will be ok
